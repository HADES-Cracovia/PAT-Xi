...
submissiondir=${submmissionbase}/PAT
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/knowakow/PNB/PAT/FILES/sep08_all    # outputdir for files AND logFiles
...
filelist=${currentDir}/dst288_new.list  # file list in local dir! not in submissiondir!!!
