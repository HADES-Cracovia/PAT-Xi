...
int main(Int_t argc, Char_t **argv)
{
  ...
  //*******************************************
  //*******************************************
  TString output_Dir ="/lustre/nyx/hades/user/knowakow/PNB/PAT/FILES/sep08_all/";
...
//  HParticlePool myParticles( &outputFile );
  ...
  myHyps.add("HmHm",eHadronNeg,eHadronNeg);
  myHyps.add("HmHmHp",eHadronNeg,eHadronNeg,eHadronPos);
#endif
  //*************************************************** 
#ifdef LEPTONS 
